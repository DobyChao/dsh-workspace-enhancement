...
const en: Record<DswKey, string> = {
  ...
  'form.remoteSandbox.hint': 'When enabled, remote commands and file tools run inside the deployed fenced core on that host (refused if the core is missing — never fall back to bare SFTP); interactive terminals are refused while it is on. Deploy the core from Settings first. Default off.',
